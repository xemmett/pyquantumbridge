...
public:
	...
	//! structure returned from processing command line
	struct CLI_Command_t
	{
	...
	//! returns false if 'x' entered to exit the console app
	bool ProcessCommandLine(CLI_Command_t* pCommandLineParams);

private:
	
	void _GetCommandLine();
